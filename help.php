...
function get_section_help($section)
{
  ...
  {
    $help = "<h3>Alert Pattern help Page</h3></br>At this page you can see detailes about problematic SQL patterns found by GreenSQL. You can press on  \"Add to Whitelist\" it this query pattern will always be legal. Another option is to press on \"Ignore this query\" button. In case if an error generated by this query pattern it will be silently ignored.<br/>";
